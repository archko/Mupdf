...
public class AKMuPDFActivity extends Activity implements FilePicker.FilePickerSupport, SensorEventListener
{
			...
			mOutlineButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					...
					if (outline != null) {
						...
						Intent intent = new Intent(AKMuPDFActivity.this, AKOutlineActivity.class);
	...
	public void proofWithResolution (int resolution)
	{
		...
		Intent intent = new Intent(this, AKMuPDFActivity.class);
...
//					break;
	...
	public void performPickFor(FilePicker picker) {
		mFilePicker = picker;
		Intent intent = new Intent(this, AKChoosePDFActivity.class);
		intent.setAction(AKChoosePDFActivity.PICK_KEY_FILE);
	...
	protected void onResume() {
		...
		//int widthPixels = Util.getScreenWidthPixelWithOrientation(this);
		int heightPixels = Util.getScreenHeightPixelWithOrientation(this);
		int tapPageMargin = heightPixels / 5;
