...
public class AKMuPDFReflowAdapter extends BaseAdapter {
	private final Context mContext;
	private final MuPDFCore mCore;

	public AKMuPDFReflowAdapter(Context c, MuPDFCore core) {
		mContext = c;
		mCore = core;
	}
	...
	private static class PDFTextView extends TextView implements MuPDFView {
		...
		float mTextSize=16;
		float mScale=1.0f;
		AKMuPDFReflowAdapter mAdapter;

		public PDFTextView(Context context, AKMuPDFReflowAdapter adapter) {
			super(context);
			mAdapter=adapter;
			mPaint = getPaint();
