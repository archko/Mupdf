...
/**
 * A {@link RecyclerView.LayoutManager} implementation which provides similar functionality to
...
public class LinearLayoutManager extends RecyclerView.LayoutManager {
    ...
    /**
     * Sets the orientation of the layout. {@link LinearLayoutManager} will do its best to
     ...
     * layouts, it depends on the layout direction. When set to true, If {@link RecyclerView}
     * is LTR, than it will render from RTL, if {@link RecyclerView} is RTL, it will render
     ...
     * {@link LinearLayoutManager} lays out 1 extra page of items while smooth scrolling and 0
     ...
     * @see RenderState#mLayoutDirection
     */
     ...
     * rest of the {@link LinearLayoutManager} and with little change, can be made publicly
