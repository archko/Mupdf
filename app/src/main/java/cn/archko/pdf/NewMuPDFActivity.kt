...
class NewMuPDFActivity : FragmentActivity(), SensorEventListener {
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            } else */run { mOutlineButton!!.visibility = View.GONE }
        } catch (e: Exception) {
            e.printStackTrace()
        }
            ...
            override fun onSingleTapConfirmed(e: MotionEvent): Boolean {
                ...
                if (e.y.toInt() < top) {
                    ...
                    if (pageNumberToast != null) {
                        ...
                        pageNumberToast = Toast.makeText(this@NewMuPDFActivity, pageText, Toast.LENGTH_SHORT)
                    }
    ...
    internal inner class PDFRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
            ...
            val view = DocPageView(baseContext, core)
        ...
        override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
            ...
            pdfHolder.mPdfView.render(bitmap, { }, false)
        }
        ...
        override fun getItemCount(): Int {
            val c = core!!.countPages()
            return c
        }

        inner class PdfHolder(internal var mPdfView: DocPageView) : RecyclerView.ViewHolder(mPdfView)

    }

    companion object {

        private val TAG = "NewMuPDFActivity"
    }
}
